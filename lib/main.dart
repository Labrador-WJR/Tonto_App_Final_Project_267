...
Future<void> main() async {
  ...
  await Supabase.initialize(
    url: 'https://bfpfmyupksojdhjmobqm.supabase.co', // Paste your URL here
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJmcGZteXVwa3NvamRoam1vYnFtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzgwNjcyOTQsImV4cCI6MjA5MzY0MzI5NH0.FGUZhw3Egn5CvbUFHxtLZIDN9ZziJzjZVTWySq1rzmA', // Paste your Anon Key here
  );

runApp(const ECommerceApp());
}
// You can now access your database anywhere in your app using this shortcut:
